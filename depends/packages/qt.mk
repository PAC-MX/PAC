...
$(package)_qtwebsockets_sha256_hash=d253688f63f636951f759023ad6059f8b9b0858b0016bfb64551fd7a8eb1bd0a

$(package)_qtwebchannel_file_name=qtwebchannel-$($(package)_suffix)
$(package)_qtwebchannel_sha256_hash=6d65885442c853303823af453299914cbf7f4001bf30e75538729839db8917b9
...
define $(package)_stage_cmds
  ...
  $(MAKE) -C qtwebchannel INSTALL_ROOT=$($(package)_staging_dir) install_subtargets && \
  $(MAKE) -C qtwebsockets INSTALL_ROOT=$($(package)_staging_dir) install_subtargets && \
